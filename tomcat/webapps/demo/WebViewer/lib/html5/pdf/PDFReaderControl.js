(function(exports) {
  ...
  exports.ReaderControl.prototype = {
    ...
    supportedBlackboxExtensions: ['docx', 'xlsx', 'pptx', 'doc', 'xls', 'csv', 'ppt', 'htm', 'html', 'tif', 'tiff', 'jp2', 'md', 'txt', 'pdf', 'jpg', 'jpeg', 'png', 'rtf', 'odf', 'odt', 'odg', 'odp', 'ods'],
        ...
        if (filename) {
          ...
          for (var i = 0; i < supportedExtensions.length; ++i) {
            if (lowered.endsWith('.' + supportedExtensions[i])) {
              extension = filename.substr(filename.length - supportedExtensions[i].length);
              break;
            }
          }
        }
