...
var paths = {
    ...
    mobileExternalScripts: [input + '/external/jquery-3.2.1.min.js', input + '/external/jquery-migrate-3.0.0.min.js', input + '/mobileSetup.js', input + '/external/jquery.mobile/jquery.mobile-1.4.4.min.js',
